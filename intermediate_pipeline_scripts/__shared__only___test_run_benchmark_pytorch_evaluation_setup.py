...
TASK_A_task.update_comp_args(__pipeline__log_file_location='/projects/ovcare/classification/cchen/ml/logs/test/log_my_test_20200311-220320.txt', __pipeline__slurm_max_time='00:20:00', __pipeline__slurm_error='/home/cochen/cchen/ml/slurm/benchmark_pytorch_evaluation.%j.err', __pipeline__slurm_machine='dlhost02', __pipeline__linker_location='/projects/ovcare/classification/cchen/ml', __pipeline__slurm_job_name='benchmark_pytorch_evaluation_slurm', __pipeline__slurm_num_cpu=2, __pipeline__singularity_args='--nv', __pipeline__slurm_num_gpu=1, __pipeline__slurm_output='/home/cochen/cchen/ml/slurm/benchmark_pytorch_evaluation.%j.out', __pipeline__slurm_memory='100G', __pipeline__singularity_image='/home/cochen/cchen/ml/docker_benchmark_pytorch_evaluation/benchmark-pytorch-evaluation_latest.sif', __pipeline__parameters=None, __pipeline__slurm_queue='dgxV100', __pipeline__output_files=None, )
...
TASK_A_task.update_comp_reqs({'docker': '__REQUIRED__'})
