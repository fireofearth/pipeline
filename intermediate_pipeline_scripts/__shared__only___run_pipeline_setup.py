...
TASK_DIVIDE_WORK_task.update_comp_args(__pipeline__work_location='/projects/ovcare/classification/cchen/ml/work', __pipeline__slurm_max_time='00:20:00', __pipeline__slurm_error='/home/cochen/cchen/ml/slurm/divide_work.%j.err', __pipeline__slurm_machine='dlhost02', __pipeline__data_location='/projects/ovcare/classification/cchen/ml/test_data', __pipeline__N=3, __pipeline__linker_location='/projects/ovcare/classification/cchen', __pipeline__slurm_job_name='divide_work_slurm', __pipeline__slurm_num_cpu=2, __pipeline__slurm_num_gpu=2, __pipeline__slurm_output='/home/cochen/cchen/ml/slurm/divide_work.%j.out', __pipeline__singularity_image='/home/cochen/cchen/ml/docker_divide_work/divide_work_latest.sif', __pipeline__parameters=None, __pipeline__slurm_queue='dgxV100', __pipeline__output_files=None, )
