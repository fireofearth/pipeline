...
@LogWarnErr(l)
@LogInfo(l)
def task_0(pipeline_name='SET_0_work_file_example'):
    sample_id = 'SET_0'
    ...
    print 'running SET_0_work_file_example pipeline with command: %s' % (cmd)
    ...
    try:
        ...
        print 'SET_0_work_file_example pipeline finished with exit code %s' % (proc.returncode)
