...
TASK_A_task.update_comp_args(__pipeline__config_file_location='/home/molinux01/cchen/ml/pipeline/downsample_data_config.json', __pipeline__docker_image='cchen/downsample_data', __pipeline__parameters=None, __pipeline__output_files=None, )
