...
TASK_A_task.update_comp_args(__pipeline__config_file_location='/home/molinux01/mnursey/example_pipeline/config.json', __pipeline__docker_image='mnursey/downsample_data', __pipeline__parameters=None, __pipeline__output_files=None, )
