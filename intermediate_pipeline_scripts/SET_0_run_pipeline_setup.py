...
TASK_CREATE_TRAINING_FILES_task.update_comp_reqs({'docker': 'docker'})

#================================================================================
#ruffus pipeline
#--------------------------------------------------------------------------------
@ruffus.follows(*[])
@ruffus.parallel(TASK_SORT_PATCHES_BY_LABEL_component.component_name, 'TASK_SORT_PATCHES_BY_LABEL', [])
