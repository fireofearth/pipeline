...
TASK_A_task.update_comp_args(__pipeline__docker_args='--runtime=nvidia --shm-size 8G', __pipeline__config_file_location='/home/molinux01/cchen/ml/pipeline/benchmark_pytorch_binary_config.json', __pipeline__docker_image='cchen/benchmark_pytorch', __pipeline__parameters=None, __pipeline__output_files=None, )
